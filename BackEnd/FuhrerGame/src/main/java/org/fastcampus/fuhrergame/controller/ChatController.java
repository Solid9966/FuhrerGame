...
public class ChatController {
    ...
    @MessageMapping("/{roomType}/{roomCode}")
    @SendTo("/topic/{roomType}/{roomCode}")
    public Message sendMessage(@DestinationVariable String roomType,
                               @DestinationVariable String roomCode,
                               @Payload Message message) {
        System.out.println("Message received in room " + roomType + "/" + roomCode + ": " + message.getContent());
        return message;
    }
}
